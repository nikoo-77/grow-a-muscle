  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-6 text-sm font-medium">
        ...
        <a href="#" className="text-2xl hover:text-blue-400" style={{ color: '#fdfcf7' }}>Programs</a>
        <a href="#" className="text-2xl hover:text-blue-400" style={{ color: '#fdfcf7' }}>Progress</a>
        <a href="#" className="text-2xl hover:text-blue-400" style={{ color: '#fdfcf7' }}>BMI Calculator</a>
        <a href="#" className="text-2xl hover:text-blue-400" style={{ color: '#fdfcf7' }}>Healthy Living</a>
        {loading ? (
